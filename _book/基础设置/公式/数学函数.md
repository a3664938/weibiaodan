...
[数学函数_PRODUCT等效]:..\..\assets\设计页面\数学函数_PRODUCT等效.png
[数学函数_PRODUCT结果]:..\..\assets\设计页面\数学函数_PRODUCT结果.png
[数学函数_SUM]:..\..\assets\设计页面\数学函数_SUM.png
[数学函数_SUM结果]:..\..\assets\设计页面\数学函数_SUM结果.png
