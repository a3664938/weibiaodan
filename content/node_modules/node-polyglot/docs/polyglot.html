...
<p>The string that separates the different phrase possibilities.</p>
  ...
  arabic: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">n</span>) </span>{</pre></div></div>
    ...
    <span class="hljs-keyword">if</span> (n % <span class="hljs-number">100</span> &gt;= <span class="hljs-number">3</span> &amp;&amp; n % <span class="hljs-number">100</span> &lt;= <span class="hljs-number">10</span>) <span class="hljs-keyword">return</span> <span class="hljs-number">3</span>;
    <span class="hljs-keyword">return</span> n % <span class="hljs-number">100</span> &gt;= <span class="hljs-number">11</span> ? <span class="hljs-number">4</span> : <span class="hljs-number">5</span>;
  },
  chinese: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>; },
  ...
  russian: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">n</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> n % <span class="hljs-number">10</span> &gt;= <span class="hljs-number">2</span> &amp;&amp; n % <span class="hljs-number">10</span> &lt;= <span class="hljs-number">4</span> &amp;&amp; (n % <span class="hljs-number">100</span> &lt; <span class="hljs-number">10</span> || n % <span class="hljs-number">100</span> &gt;= <span class="hljs-number">20</span>) ? <span class="hljs-number">1</span> : <span class="hljs-number">2</span>;
  },
  czech: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">n</span>) </span>{
  ...
  polish: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">n</span>) </span>{
    <span class="hljs-keyword">if</span> (n === <span class="hljs-number">1</span>) { <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>; }
    <span class="hljs-keyword">return</span> n % <span class="hljs-number">10</span> &gt;= <span class="hljs-number">2</span> &amp;&amp; n % <span class="hljs-number">10</span> &lt;= <span class="hljs-number">4</span> &amp;&amp; (n % <span class="hljs-number">100</span> &lt; <span class="hljs-number">10</span> || n % <span class="hljs-number">100</span> &gt;= <span class="hljs-number">20</span>) ? <span class="hljs-number">1</span> : <span class="hljs-number">2</span>;
  },
  ...
  arabic: [<span class="hljs-string">'ar'</span>],
  ...
  russian: [<span class="hljs-string">'hr'</span>, <span class="hljs-string">'ru'</span>, <span class="hljs-string">'lt'</span>],
  czech: [<span class="hljs-string">'cs'</span>, <span class="hljs-string">'sk'</span>],
...
<span class="hljs-keyword">var</span> dollarRegex = <span class="hljs-regexp">/\$/g</span>;
<span class="hljs-keyword">var</span> dollarBillsYall = <span class="hljs-string">'$$'</span>;
<span class="hljs-keyword">var</span> tokenRegex = <span class="hljs-regexp">/%\{(.*?)\}/g</span>;</pre></div></div>
...
<pre><code>transformPhrase(<span class="hljs-string">'Hello, %{name}!'</span>, {name: <span class="hljs-string">'Spike'</span>});
...
<pre><code>transformPhrase(<span class="hljs-string">'%{smart_count} new messages |||| 1 new message'</span>, {smart_count: <span class="hljs-number">1</span>}, <span class="hljs-string">'en'</span>);
<span class="hljs-comment">// "1 new message"</span>

transformPhrase(<span class="hljs-string">'%{smart_count} new messages |||| 1 new message'</span>, {smart_count: <span class="hljs-number">2</span>}, <span class="hljs-string">'en'</span>);
...
It defaults to <code>&#39;en&#39;</code> with 2 plural forms.</p>
            ...
            <div class="content"><div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">transformPhrase</span>(<span class="hljs-params">phrase, substitutions, locale</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> result = phrase;</pre></div></div>
        ...
        <li id="section-7">
            ...
            <div class="content"><div class='highlight'><pre>  <span class="hljs-keyword">var</span> options = <span class="hljs-keyword">typeof</span> substitutions === <span class="hljs-string">'number'</span> ? { smart_count: substitutions } : substitutions;</pre></div></div>
...
choose the correct plural form. This is only done if <code>count</code> is set.</p>
    ...
    result = trim(texts[pluralTypeIndex(locale || <span class="hljs-string">'en'</span>, options.smart_count)] || texts[<span class="hljs-number">0</span>]);
        ...
        <li id="section-9">
            ...
            <div class="content"><div class='highlight'><pre>  result = replace.call(result, tokenRegex, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">expression, argument</span>) </span>{
    <span class="hljs-keyword">if</span> (!has(options, argument)) { <span class="hljs-keyword">return</span> <span class="hljs-string">''</span>; }
    <span class="hljs-keyword">if</span> (options[argument] == <span class="hljs-literal">null</span>) { <span class="hljs-keyword">return</span> expression; }</pre></div></div>
...
=&gt; <span class="hljs-string">"I like to write in JavaScript."</span>
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-keyword">this</span>.phrases[key] === <span class="hljs-string">'string'</span>) {
    ...
    result = onMissingKey(key, opts, <span class="hljs-keyword">this</span>.currentLocale);
  } <span class="hljs-keyword">else</span> {
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> phrase === <span class="hljs-string">'string'</span>) {
    result = transformPhrase(phrase, opts, <span class="hljs-keyword">this</span>.currentLocale);
  }
  <span class="hljs-keyword">return</span> result;
};</pre></div></div>
...
<p>Check if polyglot has a translation for given key</p>
  ...
  <span class="hljs-keyword">return</span> has(<span class="hljs-keyword">this</span>.phrases, key);
        ...
        <li id="section-19">
            ...
            <div class="content"><div class='highlight'><pre>Polyglot.transformPhrase = transformPhrase;
